...
def capturar_tela(path_destino):
    ...
    try:
        ...
        # Fallback para UniformTypeIdentifiers (macOS 11+)
        from UniformTypeIdentifiers import UTType
        kUTTypePNG = UTType.PNG.identifier
    url = NSURL.fileURLWithPath_(path_destino)
...
def main():
    ...
    hash_anterior = None
    while True:
        nome_arquivo = f"screenshot_{num:03d}.png"
